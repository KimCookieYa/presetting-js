...
const installDependencies = (packageManager) => {
    return new Promise((resolve, reject) => {
        ...
        const installProcess = (0, child_process_1.spawn)(packageManager, args, { stdio: 'inherit' });
...
const setupHusky = (packageManager) => {
    return new Promise((resolve, reject) => {
        ...
        const runCommand = (cmdArgs) => {
            return new Promise((resolve, reject) => {
                const proc = (0, child_process_1.spawn)(packageManager, ['exec', ...cmdArgs], { stdio: 'inherit' });
                proc.on('close', (code) => {
                    if (code !== 0) {
